import projectConfig from '/test-pagic/pagic.config.js';
...
export default {
    ...
    'content': React.createElement(ReactHooksTest, { config: {
            ...
            nav: [
                {
                    link: '/test-pagic/introduction/index.html',
                    text: 'Docs'
                },
                {
                ...
                {
                    align: 'right',
                    link: '/test-pagic/about/index.html',
                    text: 'About'
                }
            ],
            outDir: 'dist',
    ...
    'script': React.createElement(React.Fragment, null,
        ...
        React.createElement("script", { src: "/test-pagic/index.js", type: "module" })),
    'sidebar': [
        {
            "text": "Introduction",
